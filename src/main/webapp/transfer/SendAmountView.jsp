...
<body>
    <div class="full-height">
        <div class="container shadow-lg">
            ...
            <form id="transferForm" action="transferAction.tr" method="post">
                <!-- 송금 금액 입력란 -->
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                    <button type="button" class="btn btn-primary btn-lg" id="confirmButton" disabled>확인</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="passwordModalLabel">계좌 비밀번호 입력</h5>
    ...
    <script>
        document.getElementById('amount').addEventListener('input', function () {
            ...
            // 7. 확인 버튼 활성화/비활성화
            document.getElementById('confirmButton').disabled = isDisabled;
        });

        // 확인 버튼 클릭 시 비밀번호 입력 모달 표시
