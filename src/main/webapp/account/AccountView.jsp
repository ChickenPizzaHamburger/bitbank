...
<body>
  <div class="container mt-4 position-relative">
    ...
    <div class="card shadow-sm rounded-3 mb-4 position-relative">
      <div class="card-body d-flex justify-content-center align-items-center" style="background-color: #66b3ff; height: 150px;"> <!-- 배경색을 연한 파란색으로 수정 -->
        ...
        <div class="text-white text-center w-100">
          ...
          <small class="text-dark" style="font-size: 1.25rem;">총 잔액: 1,234,567원</small> <!-- 총 잔액 텍스트 색상 검정색으로 변경 -->
        </div>
      </div>
