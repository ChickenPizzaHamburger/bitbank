...
public class TransferBean {
	...
	public TransferBean(String sender_account, String receiver_account, LocalDate send_time, long send_amount, String tag) {
	...
	public LocalDate getSend_time() {
		return send_time;
	}

	public void setSend_time(LocalDate send_time) {
		this.send_time = send_time;
	}
